    ...
    public static void main(String[] args) {
        ...
        while(op != 0){
            ...
            switch(op){
                ...
                case 4 -> {
                    System.out.println("Primeiro para o último? (S/s = Sim e N/n = Não)");
                    String ord = input.next();
                    if("S".equals(ord) || "s".equals(ord)){
                        System.out.println(Arrays.toString(queue.toArray(true)));
                    } else if("N".equals(ord) || "n".equals(ord)){
                        System.out.println(Arrays.toString(queue.toArray(false)));
                    }
                }
